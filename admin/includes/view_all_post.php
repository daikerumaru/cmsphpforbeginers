...
if(isset($_GET['change_to_published'])){
    ...
    $query = "UPDATE posts SET post_status = 'published' WHERE post_id=$the_post_id";   $change_to_published_query = mysqli_query($connection, $query);
    header("Location: posts.php");  
