...
$query = "SELECT * FROM comments WHERE comment_status = 'unapproved'";
        ...
        $unaproved_comments_count = mysqli_num_rows($unapproved_comments);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Date', 'Count'],
            ...
            $element_text = ['All Posts','Published','Draft', 'Comments', 'Pending', 'Users', 'Subscribers', 'Categories'];
            
            $element_count = [ $post_counts, $post_published_count, $post_draft_count, $comments_counts, $unaproved_comments_count, $users_counts, $subscriber_count, $categories_counts];
